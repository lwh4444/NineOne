...
public abstract class CallBackWrapper<T> implements Observer<T> {
    ...
    public void onError(Throwable e) {
        if (e instanceof CompositeException) {
            ...
            if (compositeException != null && compositeException.size() > 0) {
                e = compositeException.getExceptions().get(1);
            }
        }
        ...
        if (e instanceof HttpException) {
            ...
            onError("未知错误：" + e.toString(), UN_KNOWN_ERROR);
            Log.e("911", e.toString());
        }
    }
